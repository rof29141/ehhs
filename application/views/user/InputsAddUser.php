<div class="col-sm-12">
    ...
    <div class="form-group">
        <label>Company</label>
        <input type="text" name="Company_Name" id="Company_Name" readonly datafld="ignore" class="form-control required" value="<?php if(isset($data['company_name'])) print $data['company_name'];?>" />
        <input type="hidden" name="_kf_Company_ID" id="_kf_Company_ID" class="form-control required" value="<?php if(isset($data['id_company'])) print $data['id_company'];?>" />
    </div>
    <div class="form-group">

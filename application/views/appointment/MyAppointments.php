            ...
            <section>
                ...
                <div class="row" style="margin-bottom: 10px;">
                    <div class="row" style="margin-left: 5px; margin-right: 5px;">
                        ...
                        else print '<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 text-center"><h3>You don\'t have any future appointments.</h3></div>';
                        ?>

                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7" style="margin-top: 20px;margin-bottom: 20px;">
                    ...
                    <div class="row"  style="margin: 20px 0px 10px 0px;">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-center">
                            <iframe width="90%" height="200px;" src="https://www.youtube.com/embed/AwOllbfjBJ8" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                        </div>

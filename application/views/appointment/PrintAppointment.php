...
{
    $cant=sizeof($data['my_next_appointments']['data']);
    for($i=0;$i<$cant;$i++)
    {
    ?>
                ...
                <div style="border:1px solid;display: table;width: 100%;height: 90px;">
                    <div style="display: table-row;">
                        ...
                        <div class="" style="text-align:center; display: table-cell;background-color: #eee;color:#000;padding: 10px;width: 70%;">
                            ...
                            <br>
                            <div class="" style="text-align:center;font-weight: bold; font-size: 15px;"><?php print $data['my_next_appointments']['data'][$i]['APT_Date'].' '.date('h:i A',strtotime($data['my_next_appointments']['data'][$i]['APT_Time']));?></div>

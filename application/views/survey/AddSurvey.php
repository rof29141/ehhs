            ...
            <form name="frm" id="frm" >
                <fieldset class="myfieldset">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                <legend class="mylegend">I am interested in having an Educator contact me by</legend>

                                <label><input type="checkbox" name="cbx_contact_1" id="cbx_contact_1" datafld="ignore"/> Phone call</label><br>
                                <label><input type="checkbox" name="cbx_contact_2" id="cbx_contact_2" datafld="ignore"/> Phone SMS</label><br>
                                <label><input type="checkbox" name="cbx_contact_3" id="cbx_contact_3" datafld="ignore"/> Email</label><br>
                                <label><input type="checkbox" name="cbx_contact_4" id="cbx_contact_4" datafld="ignore"/> No contact me</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center text-success col-sm-3 col-md-4 col-lg-4">High interest</div>
                                    <div class="col-sm-9 col-md-8 col-lg-8"></div>
                                </div>

                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_eye" id="rbt_eye" value="5" checked/> 5</label><br>
                                ...
                                <div class="row">
                                    <div class="text-center text-danger col-sm-3 col-md-4 col-lg-4">No interest</div>
                                    <div class="col-sm-9 col-md-8 col-lg-8"></div>
                                </div>
                            </fieldset>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_tired_eye" id="rbt_tired_eye" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_eye_lids" id="rbt_eye_lids" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_wrinkles" id="rbt_wrinkles" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_forehead" id="rbt_forehead" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_crows_feet" id="rbt_crows_feet" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_botox_cosmetic" id="rbt_botox_cosmetic" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_frown_lines" id="rbt_frown_lines" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_lip_lines" id="rbt_lip_lines" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_lips" id="rbt_lips" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_facial_folds_fillers" id="rbt_facial_folds_fillers" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_brown_spots" id="rbt_brown_spots" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_scars" id="rbt_scars" value="5" checked class="error_fieldset required" /> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_chest_sun_damage" id="rbt_chest_sun_damage" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_fatial_redness" id="rbt_fatial_redness" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_nose_shape_size" id="rbt_nose_shape_size" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_jawline" id="rbt_jawline" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_jowls" id="rbt_jowls" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_neck" id="rbt_neck" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_chin" id="rbt_chin" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_turkey_gobbler" id="rbt_turkey_gobbler" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_facelift" id="rbt_facelift" value="5" checked class="error_fieldset required" /> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_skin_lesions" id="rbt_skin_lesions" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_acnescars" id="rbt_acnescars" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_hair_removal" id="rbt_hair_removal" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_hair_loss_eplacement" id="rbt_hair_loss_eplacement" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_belly" id="rbt_belly" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                <legend class="mylegend">Coolsculpting/Non-Surgical Fat Reduction</legend>
                                <div class="row">
                                    <div class="text-center text-success col-sm-3 col-md-4 col-lg-4">High interest</div>
                                    <div class="col-sm-9 col-md-8 col-lg-8"></div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_coolsculpting" id="rbt_coolsculpting" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_weight_loss" id="rbt_weight_loss" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_liposuction" id="rbt_liposuction" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_mommy_makeover" id="rbt_mommy_makeover" value="5" checked class="error_fieldset required" /> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_tummy_tuck" id="rbt_tummy_tuck" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_drooping_breasts" id="rbt_drooping_breasts" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_breast_augmentation" id="rbt_breast_augmentation" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_leg_veins" id="rbt_leg_veins" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_tattoo_removal" id="rbt_tattoo_removal" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_hands" id="rbt_hands" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_cellulite" id="rbt_cellulite" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_buttocks" id="rbt_buttocks" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_hyperhidrosis" id="rbt_hyperhidrosis" value="5" checked class="error_fieldset required" /> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_teeth_whitening" id="rbt_teeth_whitening" value="5" checked/> 5</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_image_consulting" id="rbt_image_consulting" value="5" checked/> 5</label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                            <fieldset class="myfieldset" style="margin-top: 0px;">
                                ...
                                <div class="row">
                                    <div class="text-center col-sm-3 col-md-4 col-lg-4">
                                        <label><input type="radio" name="rbt_personal_makeover" id="rbt_personal_makeover" value="5" checked class="error_fieldset required" /> 5</label><br>
            ...
            $.validator.setDefaults(
                {
                    ...
                    errorPlacement: function (error, element)
                    {
                        ...
                        {
                            //$(element).closest('.myfieldset').addClass('has-error');
                            $(element).closest('.myfieldset').css("color", "red");
